...
HELP_ADMIN = {
    ...
    * Create and set up roles which EVE Commissar is supposed to grant members.
      * EVE Commissar should have his role on server higher than roles that it will granting \\ revoking.
    ...
    * locale name for notification text
        
    After creating rule EVE Commissar can ran automated job for granting \\ revoking roles.
...
HELP_USER = {
    ...
    Before use EVE Commissar should be configured for Discord Server by admins.    
